...
class ProductOwnerController extends Controller implements FromArray, WithHeadings
{
    public function index(Request $request): View
    {
        ...
        // Whitelist allowed sort columns to prevent SQL injection or errors
        ...
        return view('owner.product.index', compact('products', 'categories', 'q', 'categoryId', 'sortBy', 'direction'));
    }
    ...
    public function destroy(Product $product): RedirectResponse
    {
        ...
        $product->delete();
        return redirect()->route('owner.product.index')->with('success', 'Produk berhasil dihapus secara aman');
    }
    ...
    public function bulkDestroy(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('owner.product.index')->with('success', "{$count} produk berhasil dihapus secara aman.");
    }
