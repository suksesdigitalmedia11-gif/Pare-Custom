...
class ProductKepalaTokoController extends Controller implements FromArray, WithHeadings
{
    ...
    public function logs(Request $request): View
    {
        ...
        return view('kepala-toko.product.logs', compact('logs', 'q', 'source', 'productId', 'selectedProduct', 'dateFrom', 'dateTo'));
    }
    ...
    public function destroy(Product $product): RedirectResponse
    {
        ...
        $product->delete();
        return redirect()->route('kepala-toko.product.index')->with('success', 'Produk berhasil dihapus secara aman');
    }
    ...
    public function bulkDestroy(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('kepala-toko.product.index')->with('success', "{$count} produk berhasil dihapus secara aman.");
    }
