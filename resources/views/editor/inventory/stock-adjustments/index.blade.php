            ...
            <div class="p-4 lg:p-8">
                ...
                <div class="px-6 py-8">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                        ...
                        <div>
                            <a href="{{ route('editor.inventory.stock-adjustments.create') }}"
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div
                            ...
                            <!-- Search -->
                            <form action="{{ route('editor.inventory.stock-adjustments.index') }}" method="GET"
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="{{ route('editor.inventory.stock-adjustments.index', ['type' => 'out']) }}"
                                    ...
                                    @forelse($adjustments as $adj)
                                        <tr class="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <a href="{{ route('editor.inventory.stock-adjustments.show', $adj->id) }}"
