        ...
        <div class="bg-white p-6 rounded-xl shadow-lg">
          ...
          <div class="flex border-b mb-4 overflow-x-auto">
            <a href="{{ route('editor.inventory.index') }}" 
               class="px-4 py-2 font-semibold whitespace-nowrap {{ request()->routeIs('editor.inventory.index') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">Overview</a>
            <a href="{{ route('editor.inventory.stock-ins.index') }}" 
               class="px-4 py-2 font-semibold whitespace-nowrap {{ request()->routeIs('editor.inventory.stock-ins.*') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">Stok Masuk</a>
            <a href="{{ route('editor.inventory.stock-opnames.index') }}" 
               class="px-4 py-2 font-semibold whitespace-nowrap {{ request()->routeIs('editor.inventory.stock-opnames.*') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">Stock Opname</a>
            <a href="{{ route('editor.inventory.stock-movements.index') }}" 
               class="px-4 py-2 font-semibold whitespace-nowrap {{ request()->routeIs('editor.inventory.stock-movements.*') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">Pergerakan Stok</a>
          </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                  ...
                  <div>
                      ...
                      <div class="flex gap-2">
                          ...
                          <a href="{{ route('editor.inventory.stock-movements.index') }}" class="bg-gray-200 text-gray-700 px-3 py-2 rounded-lg hover:bg-gray-300 transition-colors" title="Reset">
