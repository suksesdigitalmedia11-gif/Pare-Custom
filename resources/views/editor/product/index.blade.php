...
<head>
    ...
    <title>Daftar Produk - Editor - Pare Custom</title>
...
<body class="bg-gray-100">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <a href="{{ route('editor.product.create') }}" 
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                            <form method="GET" action="{{ route('editor.product.index') }}">
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                                    ...
                                    <div class="md:col-span-4 flex gap-2">
                                        ...
                                        <a href="{{ route('editor.product.index') }}" class="px-5 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition shadow-sm">
                                            Reset
                                        </a>
                                    </div>
                                </div>
                                ...
                                <thead class="bg-gray-50 text-gray-600 font-semibold uppercase text-xs tracking-wider">
                                    <tr>
                                        <th class="px-6 py-4 border-b border-gray-100">
                                            <a href="{{ route('editor.product.index', array_merge(request()->query(), ['sort_by' => 'name', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc'])) }}" class="group flex items-center gap-1 cursor-pointer hover:text-blue-600">
                                                Produk
                                        ...
                                        <tr class="hover:bg-gray-50/80 transition-colors group">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <div class="flex items-center justify-center gap-2">
                                                    <a href="{{ route('editor.product.show', $product) }}" class="p-2 rounded-lg text-gray-500 hover:bg-blue-50 hover:text-blue-600 transition-colors" title="Detail">
                                                        <i class="bi bi-eye"></i>
                                                    </a>
                                                    <a href="{{ route('editor.product.edit', $product) }}" class="p-2 rounded-lg text-gray-500 hover:bg-yellow-50 hover:text-yellow-600 transition-colors" title="Edit">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <button type="button" onclick="confirmDelete('{{ route('editor.product.destroy', $product) }}', '{{ $product->name }}')" 
    ...
    <div id="importModal" class="fixed inset-0 bg-gray-900/50 hidden z-50 flex items-center justify-center transition-opacity opacity-0 pointer-events-none" style="transition: opacity 0.3s ease;">
        <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl transform scale-95 transition-transform duration-300" style="transition: transform 0.3s ease;">
            ...
            <form action="{{ route('editor.product.import') }}" method="POST" enctype="multipart/form-data" id="importForm" class="p-6">
                @csrf
                <div class="space-y-4">
                    <div>
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3">
                        ...
                        <div>
                            ...
                            <a href="{{ route('editor.product.download-template') }}" class="text-xs font-bold text-blue-700 hover:underline">
