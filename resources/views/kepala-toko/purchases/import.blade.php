                ...
                <div class="bg-white p-6 rounded-xl shadow-lg mb-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="bg-green-50 p-4 rounded-lg">
                            ...
                            <a href="{{ route('kepala-toko.purchases.download-template') }}"
                    ...
                    <div class="bg-white border rounded-lg p-5 mb-6 shadow-sm">
                        ...
                        <!-- Import Form -->
                        <form action="{{ route('kepala-toko.purchases.import') }}" method="POST"
                            enctype="multipart/form-data" class="bg-gray-50 p-6 rounded-lg">
                            @csrf
