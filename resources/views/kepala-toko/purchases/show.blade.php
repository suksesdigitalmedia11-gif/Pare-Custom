...
<body class="bg-gray-100">
                                    ...
                                    <div class="bg-blue-50 p-3 rounded-lg">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <div>
                                                ...
                                                <a href="{{ route('kepala-toko.sales.show', $purchase->salesOrder->id) }}" class="inline-flex items-center px-2 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700 mt-1 transition-colors shadow-sm font-semibold">
    ...
    @if($purchase->status === 'printing' && in_array(auth()->user()->usertype, ['kepala_toko', 'owner']))
