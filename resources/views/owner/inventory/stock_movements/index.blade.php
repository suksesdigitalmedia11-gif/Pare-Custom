        ...
        <div class="mb-8">
            ...
            <div class="flex border-b border-gray-200 mt-6 overflow-x-auto bg-white rounded-t-xl px-4 pt-2">
                <a href="{{ route('owner.inventory.index') }}" 
                   class="px-6 py-3 font-semibold whitespace-nowrap transition-all {{ request()->routeIs('owner.inventory.index') ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-blue-600' }}">Overview</a>
                <a href="{{ route('owner.inventory.stock-ins.index') }}" 
                   class="px-6 py-3 font-semibold whitespace-nowrap transition-all {{ request()->routeIs('owner.inventory.stock-ins.*') ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-blue-600' }}">Stok Masuk</a>
                <a href="{{ route('owner.inventory.stock-opnames.index') }}" 
                   class="px-6 py-3 font-semibold whitespace-nowrap transition-all {{ request()->routeIs('owner.inventory.stock-opnames.*') ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-blue-600' }}">Stock Opname</a>
                <a href="{{ route('owner.inventory.stock-movements.index') }}" 
                   class="px-6 py-3 font-semibold whitespace-nowrap transition-all {{ request()->routeIs('owner.inventory.stock-movements.*') ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-blue-600' }}">Pergerakan Stok</a>
            </div>
        </div>
    ...
    function movementApp() {
        return {
            ...
            async openModal(productId) {
                ...
                try {
                    const response = await fetch(`{{ route('owner.inventory.stock-movements.index') }}/${productId}/details?from=${from}&to=${to}`);
