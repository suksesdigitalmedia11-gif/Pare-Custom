        ...
        <div class="flex-1">
            ...
            <div class="p-4 lg:p-8">
                ...
                <div class="px-6 py-8" x-data="stockAdjustmentForm()" x-init="initForm()">
                    ...
                    <form action="{{ route('owner.inventory.stock-adjustments.store') }}" method="POST"
    ...
    <script>
        function stockAdjustmentForm() {
            return {
                ...
                checkPersist() {
                    const saved = localStorage.getItem('stock_adjustment_draft_owner');
                    if (saved) {
                        try {
                ...
                saveDraft() {
                    ...
                    localStorage.setItem('stock_adjustment_draft_owner', JSON.stringify(draft));
                },
                initForm() {
                    this.checkPersist();
                ...
                resetForm() {
                    if (confirm('Yakin ingin mereset formulir? Data draft akan dihapus.')) {
                        ...
                        localStorage.removeItem('stock_adjustment_draft_owner');
                    }
                },
                async searchProducts() {
                    ...
                    this.isLoading = true;
                    try {
                        const response = await axios.get('{{ route("owner.catalog.products.search") }}', { params: { q: this.searchQuery } });
                ...
                submitForm(e) {
                    ...
                    this.isSubmitting = true; localStorage.removeItem('stock_adjustment_draft_owner'); e.target.submit();
                }
            }
        }
    </script>
