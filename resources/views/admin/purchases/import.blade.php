                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="bg-blue-50 p-4 rounded-lg">
                            ...
                            <ul class="text-sm text-blue-700 space-y-1">
                                ...
                                <li>• <strong>PO_NUMBER boleh dikosongkan</strong> & akan digenerate otomatis (format
                                    POYYMMDDXXXX).</li>
                                <li>• <strong>SUPPLIER_NAME wajib diisi</strong> & akan dibuat otomatis jika belum ada.
                                </li>
                                <li>• <strong>PURCHASE_TYPE</strong> hanya boleh: <code>kain</code> atau
                                    <code>produk_jadi</code>.</li>
                                <li>• Satu PO bisa berisi beberapa baris item dengan <strong>PO_NUMBER yang
                                        sama</strong>.</li>
                        ...
                        <div class="mb-6 bg-yellow-50 p-4 rounded border border-yellow-200">
                            ...
                            <div class="flex flex-col space-y-3">
                                <label class="flex items-start">
                                    ...
                                    <div class="ml-2">
                                        <span class="block font-semibold text-gray-800">1. Migrasi Data Lama (Keuangan
                                            Saja)</span>
