...
<head>
    ...
    <style>
        ...
        .action-menu { display: none; position: absolute; right: 0; top: 100%; z-index: 50; min-width: 180px; margin-top: 0.25rem; }
        .action-dropdown.active .action-menu { display: block; }
    </style>
</head>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="{{ route('admin.purchases.import-form') }}" 
                               class="bg-purple-600 text-white px-3 lg:px-4 py-2 rounded-md hover:bg-purple-700 inline-flex items-center text-sm">
                                <i class="bi bi-upload mr-2"></i> <span class="hidden sm:inline">Import</span>
                            </a>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-50 transition-colors">
                                    <td class="px-3 lg:px-4 py-3">
                                        <a class="text-[#005281] hover:underline font-medium" href="{{ route('admin.purchases.show', $p) }}">{{ $p->po_number }}</a>
