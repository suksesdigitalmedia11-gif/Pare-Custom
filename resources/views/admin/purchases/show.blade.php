                            ...
                            <div class="bg-blue-50 p-3 rounded-lg">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ route('admin.sales.show', $purchase->salesOrder->id) }}" class="inline-flex items-center px-2 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700 mt-1 transition-colors shadow-sm font-semibold">
...
@endif
    ...
    @if(!in_array($purchase->status, ['selesai']))
        <form method="POST" action="{{ route('admin.purchases.destroy', $purchase) }}" class="mt-2">
            @csrf @method('DELETE')
            <button class="w-full px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700 transition-colors" 
