                ...
                <div class="p-6 bg-gray-100 min-h-screen">
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                            ...
                            <div>
                                <a href="{{ route('admin.product.export-price-update') }}" class="btn btn-warning text-dark font-medium shadow-sm">
                        ...
                        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6">
                            <form method="GET" action="{{ route('admin.product.logs') }}" class="row g-3 items-end">
                                @if($productId)
                                ...
                                <div class="col-md-2 d-flex gap-2">
                                    ...
                                    <a href="{{ route('admin.product.logs') }}" class="btn btn-light border btn-sm" title="Reset Filter">
