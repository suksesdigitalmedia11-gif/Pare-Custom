    ...
    <script>
        function stockAdjustmentForm() {
            return {
                ...
                checkPersist() {
                    const saved = localStorage.getItem('stock_adjustment_draft_admin');
                    if (saved) {
                        try {
                ...
                saveDraft() {
                    ...
                    localStorage.setItem('stock_adjustment_draft_admin', JSON.stringify(draft));
                },
                initForm() {
                    this.checkPersist();
                ...
                resetForm() {
                    if (confirm('Yakin ingin mereset formulir? Data draft akan dihapus.')) {
                        ...
                        localStorage.removeItem('stock_adjustment_draft_admin');
                    }
                },
                async searchProducts() {
                    ...
                    this.isLoading = true;
                    try {
                        const response = await axios.get('{{ route("admin.catalog.products.search") }}', { params: { q: this.searchQuery } });
                ...
                submitForm(e) {
                    ...
                    this.isSubmitting = true; localStorage.removeItem('stock_adjustment_draft_admin'); e.target.submit();
                }
            }
        }
    </script>
