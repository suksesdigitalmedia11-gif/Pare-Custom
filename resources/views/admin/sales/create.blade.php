                    ...
                    <div class="form-section">
                        <div class="form-card p-6 mb-6">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <label class="relative flex cursor-pointer">
                                            <input type="radio" name="order_type" value="jahit_sendiri" checked
                                                class="peer sr-only">
                                            <div
                                                class="flex items-center justify-center w-full p-4 border-2 border-gray-200 rounded-xl text-gray-600 hover:border-gray-300 peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-700 transition-all">
                                ...
                                <!-- Order Date -->
                                <div>
                                    <label for="order_date" class="block text-sm font-medium text-gray-700 mb-2">Tanggal
                                        Order</label>
                                ...
                                <div class="relative">
                                    ...
                                    <div id="selected_customer"
                                        class="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-xl {{ old('customer_id') ? '' : 'hidden' }}">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <span id="customer_display_name"
                                                    class="font-medium text-blue-900">{{ old('customer_name') }}</span>
                                                <span id="customer_display_phone"
                                                    class="text-sm text-blue-700 ml-2">{{ old('customer_phone') ? '(' . old('customer_phone') . ')' : '' }}</span>
                                            </div>
                                            <button type="button" id="clear_customer"
                                    ...
                                    <div id="new_customer_fields"
                                        class="mt-3 p-4 bg-gray-50 border border-gray-200 rounded-xl hidden">
                            ...
                            <div class="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-xl">
                                ...
                                <div id="supplier-section" class="mt-4 hidden">
                                    ...
                                    <div id="selected_supplier"
                                        class="mt-2 p-3 bg-orange-100 border border-orange-300 rounded-lg hidden">
                                        <div class="flex items-center justify-between">
                                            <span id="supplier_display_name" class="font-medium text-orange-900"></span>
                                            <button type="button" id="clear_supplier"
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-card p-6 mb-6">
                            ...
                            <div id="items-container" class="space-y-4">
                                <!-- Initial Item Row -->
                                <div
                                    class="item-row grid grid-cols-1 lg:grid-cols-12 gap-4 p-4 border border-gray-200 rounded-xl">
                                    <div class="lg:col-span-6">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div
                                                class="product-results autocomplete-dropdown hidden absolute z-40 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input type="number" name="items[0][qty]"
                                            ...
                                            min="1" required value="1" placeholder="1">
                                    </div>
                                    <div class="lg:col-span-1 flex items-end">
                                        <button type="button"
                                            class="remove-item w-full py-3 text-red-500 hover:text-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                            disabled>
                        ...
                        <div class="form-card p-6 mb-6">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="payment_method" id="payment_method" required
                                        ...
                                        <option value="split" {{ old('payment_method') == 'split' ? 'selected' : '' }}>
                                ...
                                <div>
                                    <label for="payment_status"
                                        class="block text-sm font-medium text-gray-700 mb-2">Status Pembayaran</label>
                                    <select name="payment_status" id="payment_status"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                                        <option value="dp" {{ old('payment_status') == 'dp' ? 'selected' : '' }}>DP
                                        </option>
                                        <option value="lunas" {{ old('payment_status') == 'lunas' ? 'selected' : '' }}>
                                            Lunas</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="payment_amount" id="payment_amount"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                        step="0.01" min="0" value="{{ old('payment_amount') }}" placeholder="0">
                                ...
                                <!-- Payment Date -->
                                <div>
                                    <label for="paid_at" class="block text-sm font-medium text-gray-700 mb-2">Tanggal
                                        Pembayaran</label>
                            ...
                            <div id="split-payment-fields"
                                class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl hidden">
                                <h3 class="text-lg font-medium text-blue-900 mb-4">Split Payment</h3>
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <div>
                                        <label for="cash_amount"
                                            class="block text-sm font-medium text-blue-700 mb-2">Jumlah Cash</label>
                                        <input type="number" name="cash_amount" id="cash_amount"
                                            ...
                                            step="0.01" min="0" value="{{ old('cash_amount') }}" placeholder="0">
                                    </div>
                                    <div>
                                        <label for="transfer_amount"
                                            class="block text-sm font-medium text-blue-700 mb-2">Jumlah Transfer</label>
                                        <input type="number" name="transfer_amount" id="transfer_amount"
                                            class="w-full px-4 py-3 border border-blue-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                            step="0.01" min="0" value="{{ old('transfer_amount') }}" placeholder="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Proof Field -->
                            <div id="proof-field"
                                class="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-xl hidden">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="reference_number" id="reference_number"
                                            class="w-full px-4 py-3 border border-purple-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                                            placeholder="TRF123456789" value="{{ old('reference_number') }}">
                                ...
                                <div class="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                    <p class="text-sm text-yellow-800">
                                        ...
                                        Untuk transfer/split <strong>dengan pembayaran</strong>, wajib mengisi salah
                                        satu: Bukti Transfer atau No Referensi
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <div>
                                    <label for="discount_total"
                                        class="block text-sm font-medium text-gray-600 mb-2">Diskon Total</label>
                                    <input type="number" name="discount_total" id="discount_total"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                        min="0" step="0.01" value="{{ old('discount_total', 0) }}" placeholder="0">
                                </div>
                                <div>
                                    <label for="shipping_cost"
                                        class="block text-sm font-medium text-gray-600 mb-2">Ongkir</label>
                                    <input type="number" name="shipping_cost" id="shipping_cost"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                        min="0" step="0.01" value="{{ old('shipping_cost', 0) }}" placeholder="0">
                                </div>
                                <div class="text-center">
