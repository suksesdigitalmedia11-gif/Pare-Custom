            ...
            <div class="p-4 lg:p-8">
                <div class="bg-white p-6 rounded-xl shadow-lg mb-6">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('finance.purchases.show', $purchase) }}" class="px-4 py-2 border rounded">Kembali</a>
                    </div>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-lg">
                    <form method="POST" action="{{ route('finance.purchases.update', $purchase) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="pt-4 flex justify-end gap-2">
                            ...
                            <a href="{{ route('finance.purchases.show', $purchase) }}" class="px-4 py-2 rounded border">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        function purchaseForm() {
            return {
                ...
                selectProduct(idx, p) {
                    ...
                    it.sku = p.sku || '';
                    // Set cost_price jika ada, jika null/0 biarkan kosong agar bisa input manual
                    it.cost_price = p.cost_price && parseFloat(p.cost_price) > 0 ? p.cost_price : '';
                    it.suggestions = [];
                }
            };
        }
